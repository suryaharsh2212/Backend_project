...
app.use(cors({origin: process.env.CORS_ORIGIN},{Credential:true})) // this middleware is a cross origin resource sharing which allows resouce sharing with the url we want 
